...
class Init():
    ...
    def __init__(self):
        ...
        self.dir_path = os.path.dirname(os.path.realpath(__file__)) + '/input/' + self.start_date + '_' + \
                        self.end_date + '/'
...
class FinnHub():
    ...
    def __init__(self,start_date,end_date,start_date_,end_date_,tickers,dir_path,db_name):
        ...
        self.tickers = get_tickers() #get_tickers is to get tickers from all the companies listedin the s&p 500
